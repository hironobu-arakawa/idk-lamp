# 01_human-idk-lamp — "idk-lamp" on the Human Side
...
**make decisions while sharing uncertainty**.
...
- Humans also need a "Not Known Lamp" (idk-lamp)
- Uncertainty naturally shared between humans is not shared with AI
- AI cannot become an accomplice in uncertainty
- Showing a state of inability to judge is not weakness but a boundary
- The human-side idk-lamp is a structure to protect the soundness of decision-making
- An existence paired with Decision Closure

---

# 10. Documents to Read Next

- 02_uncertainty.md (Handling Uncertainty)
